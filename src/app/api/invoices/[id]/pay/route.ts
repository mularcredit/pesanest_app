...
export async function POST(
    ...
    try {
        ...
        const { amount, paymentDate, method, reference, notes, bankAccountId, paybillAccountId, paystackAccountId } = body;
        ...
        try {
            await AccountingEngine.postVendorPayment(id, amount, { bankAccountId, paybillAccountId, paystackAccountId });
