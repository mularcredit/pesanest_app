 ...
 *
 * Lists the real bank/paybill accounts a payment can actually settle
 * through, for any UI that needs to ask "which account did this move
 ...
 *
 * Returns [{ id, kind: 'BANK' | 'PAYBILL', label, glAccountId }].
 */
