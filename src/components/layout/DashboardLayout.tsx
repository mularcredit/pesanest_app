...
import { BillingAssistant } from "@/components/assistant/BillingAssistant";
...
export default function DashboardLayout({
    ...
    return (
        <div className="flex flex-col h-screen overflow-hidden bg-[var(--page)] font-[var(--font-midnight)] text-[var(--t1)]">
            ...
            {/* Header spans the full width, above the sidebar and content */}
